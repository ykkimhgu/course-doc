...
* [Visual Studio Code](installing-vs-code-mac-linux.md#visual-studio-code)
* [부록1: CMake 설치](installing-vs-code-mac-linux.md#부록1-cmake-설치)
* [부록2: Visual Sutdio 빌드 도구 설치](installing-vs-code-mac-linux.md#부록2-visual-studio-빌드-도구-설치)
...
1.  [설치 사이트](https://visualstudio.microsoft.com/ko/downloads/)에 접속하여 설치 파일을 다운로드 받는다.
    ...
    ![](../../.gitbook/assets/vscode_site.png)
2.  다운로드 받은 설치 파일을 실행한다.

    ![](../../.gitbook/assets/vscode_installer.png) ![](../../.gitbook/assets/vscode_install1.png) ![](../../.gitbook/assets/vscode_install2.png) ![](../../.gitbook/assets/vscode_install3.png) ![](../../.gitbook/assets/vscode_install4.png) ![](../../.gitbook/assets/vscode_install5.png)
3. C/C++ 개발에 필요한 확장을 설치한다.

![](../../.gitbook/assets/vscode_window.png) ![](../../.gitbook/assets/ex.png)

4. CMake를 설치한다.([부록1: CMake 설치](installing-vs-code-mac-linux.md#부록1-cmake-설치) 참고)
5. 빌드 도구를 설치한다. (Windows만 해당, [부록: Visual Sutdio 빌드 도구 설치](installing-vs-code-mac-linux.md#부록2-visual-studio-빌드-도구-설치) 참고)
...
3.  프로젝트 이름을 입력한다. 프로젝트 이름은 생성한 폴더 이름과 동일하게 설정한다.
    ...
    ![](../../.gitbook/assets/vscode3.png)
4.  언어는 `C`를 선택한다.

    ![](../../.gitbook/assets/vscode4.png)
5.  실행파일(Excutable)을 선택한다.

    ![](../../.gitbook/assets/vscode5.png)
6.  빌드 설정을 추가한다.

    ![](../../.gitbook/assets/vscode7.png)
7.  `컴파일러에서 만들기`를 선택한다.

    ![](../../.gitbook/assets/vscode8.png)
8.  컴파일러를 선택한다. **윈도우는 Visual Studio**, **Mac은 Clang**을 선택한다.

    ![](../../.gitbook/assets/vscode9.png)
9.  `CMakeLists.txt`에 아래 내용을 복사한다. `<PROJECT>`부분은 **본인의 프로젝트 이름**으로 **수정**한다.
...
1. [CMake 설치 사이트](https://cmake.org/download/)에 접속하여 최신버전 CMake를 설치한다.![](../../.gitbook/assets/cmake_download.png)
2.  설치 프로그램에서 아래 순서와 같이 설치한다.

    ![](../../.gitbook/assets/cmake_install1.png) ![](../../.gitbook/assets/cmake_install2.png) ![](../../.gitbook/assets/cmake_install3.png)
...
1.  [설치 사이트](https://visualstudio.microsoft.com/ko/downloads/)에 접속하여 인스톨러를 다운로드 받는다.
    ...
    ![](../../.gitbook/assets/vsbuildtool_install.png)
2.  인스톨러에서 아래와 같이 설정 후 설치한다.

    ![](../../.gitbook/assets/vsbuildtool_installer.png)
